...
const createVacancyValidator = z.object({
  ...
  roomType: z.enum(['1BHK', '2BHK', '3BHK', '4BHK', '5BHK'], 'Invalid room type'),
  preferredType: z.enum(['Student', 'Boy', 'Girl', 'Professional', 'Couple']).optional(),
  parking: z.boolean().optional(),
  available: z.string().transform((str) => new Date(str)).optional(), // Converts string to Date
});
